...
data/i18n/{es,pt}.json   HAND-AUTHORED exact-key translation dictionaries (committed). In THIS repo they were written by hand, NOT by scripts/translate.js — see their _meta.generatedBy and humanReviewed. Re-key them whenever English prose changes; test/i18n-completeness.test.js fails on a missing or a stale key.
